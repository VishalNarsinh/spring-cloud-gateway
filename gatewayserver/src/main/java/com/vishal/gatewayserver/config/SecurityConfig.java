package com.vishal.gatewayserver.config;
...
public class SecurityConfig {
	...
	public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity serverHttpSecurity) {
		serverHttpSecurity.authorizeExchange(exchange -> exchange.pathMatchers(HttpMethod.GET)
						.permitAll()
						.pathMatchers("/custom/accounts/**")
						.hasRole("ACCOUNTS")
						.pathMatchers("/custom/cards/**")
						.hasRole("CARDS")
						.pathMatchers("/custom/loans/**")
						.hasRole("LOANS"))
